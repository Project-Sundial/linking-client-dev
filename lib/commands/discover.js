...
var discover = exports.discover = function discover(options) {
...
var editCrontab = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(crontabText, full) {
    var lines, state, index, _iterator, _step, line, _state$modifiedLines;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          crontabText = (0, _path.addPath)(crontabText);
          lines = crontabText.split('\n');
          state = {
            modifiedLines: [],
            count: 0,
        ...
        case 7:
          ...
          state.line = line;
          _context.next = 12;
          return processLine(state, full);
        case 12:
          if (!state.done) {
            _context.next = 15;
            break;
          }
          (_state$modifiedLines = state.modifiedLines).push.apply(_state$modifiedLines, _toConsumableArray(lines.slice(index)));
  ...
  return function editCrontab(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var processLine = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(state, full) {
    var modifiedLines, line, _parse, schedule, command, question, userResponse;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          modifiedLines = state.modifiedLines, line = state.line;
          ...
          modifiedLines.push((0, _path.convertPath)(line));
        ...
        case 5:
          ...
          question = "\nAdd cronjob ".concat(state.count, ":\n").concat(line, "\n[y/n/q (quit)]: ");
          _context2.next = 10;
  ...
  return function processLine(_x3, _x4) {
