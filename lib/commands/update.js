...
var editCrontab = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(crontabText, job) {
    var newLine, newCrontabText;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          newLine = (0, _cronjob.generateCronString)(job);
          newCrontabText = crontabText + '\n' + newLine;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _api.getUpdates)();
        case 3:
          updates = _context2.sent;
          console.log('the updates retrieved from docker app:', updates);
          (0, _child_process.exec)('crontab -l > /Users/Sofia/Programming/Capstone/capstone-project/cli/log.txt', {
            timeout: 5000
          ...
          _context2.next = 8;
          return (0, _api.successfulSync)(updates);
        case 8:
          _context2.next = 13;
          break;
        case 10:
          ...
          console.log('error fetching updated from docker app', _context2.t0);
        case 13:
        case "end":
