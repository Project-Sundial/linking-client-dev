...
var formatCronText = function formatCronText(jobs) {
  var wrappedJobs = jobs.map(function (job) {
    return (0, _cronjob.generateCronString)(job);
  });
  var crontabText = wrappedJobs.join('\n ');
  return crontabText;
};
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          crontabText = formatCronText(updates);
        ...
        case 13:
          ...
          console.log('error fetching updated jobs from docker app', _context.t0);
        case 16:
        case "end":
